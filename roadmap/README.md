...
> **Current overall status:** **Phase 4 — 🟡 in progress** (Phases 0–3 ✅). The `orchestration`
...
> is 🟡 in progress:** spec [`0008-build-instance`](../specs/0008-build-instance/spec.md) adds the
...
> overwrites gated behind `--force`), via the new `build` CLI command. **Crash diagnosis (`0009`) is
> next.**
...
| 4 | [Build, Launch & Crash Diagnosis](./phase-4-build-launch-crash-diagnosis.md) | 🟡 | [`0008`](../specs/0008-build-instance/spec.md) |
