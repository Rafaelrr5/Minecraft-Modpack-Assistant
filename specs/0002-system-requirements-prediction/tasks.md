...
- [ ] **T-0002-01 — Define `RequirementsReport` + flags types**
...
- [ ] **T-0002-02 — `requiredJava(mcVersion)`**
...
- [ ] **T-0002-04 — Category weights table**
...
- [ ] **T-0002-06 — `estimateRam` (min/recommended + `-Xmx`)**
...
- [ ] **T-0002-09 — `predictRequirements` assembly**
...
- [ ] **T-0002-10 — Acceptance-criteria test suite**
...
- [ ] **T-0002-12 — `requirements` CLI command + orchestration step**
...
- [ ] AC-1…AC-7 met and demonstrated.
- [ ] All Constitution gates in [`spec.md`](./spec.md) pass.
- [ ] Deterministic tests + heuristic property tests green; figures carry confidence +
      rationale.
