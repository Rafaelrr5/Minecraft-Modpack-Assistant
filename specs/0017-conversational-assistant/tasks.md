...
- [ ] **T-0017-01 — Extend the `ChatModel` port with tool-calling**
...
- [ ] **T-0017-02 — NVIDIA adapter tool-calling + contract test**
...
- [ ] **T-0017-03 — Assistant types + module scaffold**
...
- [ ] **T-0017-04 — Tool registry over existing capabilities**
...
- [ ] **T-0017-06 — Session loop (read-only tools) with fake `ChatModel`**
...
- [ ] **T-0017-07 — Confirmation-gated `apply_build`**
...
- [ ] **T-0017-08 — Deterministic fallback (no LLM)**
...
- [ ] **T-0017-09 — Observability + egress disclosure + "why?"**
...
- [ ] **T-0017-10 — `assistant` CLI command + wiring**
...
- [ ] All acceptance criteria (AC-1…AC-8) met and demonstrated.
- [ ] All Constitution gates pass (or deviations justified in the spec).
- [ ] Unit + contract tests green; `npm run check` green.
- [ ] Docs + roadmap + repo maps updated; `0017` marked `done`.
